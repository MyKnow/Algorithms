# [int] N: 도착해야 하는 목표 방 번호 (범위: 1 <= N <= 1,000,000,000)
N = int(input())
...
# [int] requireRoomsOfNowOrbit: 현재 궤도를 구성하기 위해 필요한 방의 개수의 총합
requireRoomsOfNowOrbit = 0

# [int] lastRoomOfNowOrbit: 현재 탐색 중인 궤도의 마지막 방 번호
lastRoomOfNowOrbit = 1

# [int] nowOrbitIndex: 현재 탐색 중인 궤도 번호
nowOrbitIndex = 1
